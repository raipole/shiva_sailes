...
def iris_data():
    ...
    return X,y
def my_main_XGBoost_classification():
    X,y=iris_data()
    ...
    accuracy_direct = model.score(x_test, y_test)
...
#
def my_main():
    mymain_XGBoost_regression()
    my_main_XGBoost_classification()
# #
# #
# #
