    ...
    for index, row in data.iterrows():
        ...
        if result is not None:
            ...
            for item in result:
                ...
                # ChEMBL ID
                if "Molecule ChEMBL ID" in data.columns:
...
output_file = (
    "Morgan_Top20_Feature_Structural_Information.xlsx"
)
...
for bit_number in important_bits:
    ...
    bit_rows = results_df[
        results_df["Feature_Bit"] == bit_number
        ]
